							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										...
										<img id="preview-img" class="thumbnail" width="300px" src="{{asset('lib/storage/app/avarta/'.$product->pro_img)}}">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<select required name="cate" class="form-control">
											@foreach ($listcate as $item)
												<option value="{{$item->cate_id}}" @if ($product->pro_cate == $item->cate_id) selected
